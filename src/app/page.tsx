                ...
                >
                    <div className="space-y-2">
                        ...
                        <p className="text-center text-secondary-text">
                            An easy, dirt cheap way to share your event invitations. Upload
                            your
                            <br /> custom design, get a shareable link. And then party time
                            🥳.
                        </p>
                    </div>
                    <Button>
                ...
                <div className="space-y-9">
                    ...
                    <div className="flex items-center justify-center gap-12">
                        <div className="flex flex-col items-center gap-3">
                            <h3 className="text-5xl font-semibold text-blue">{0}</h3>
                        ...
                        />
                        <div className="flex flex-col items-center gap-3">
                            <h3 className="text-5xl font-semibold text-blue">{100}%</h3>
                            <p className="text-secondary-text">Satisfaction rate (by me)</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <Card title="1. Upload Your Invitation Design">
                            <p className="text-secondary-text">
                                Already have a design? Perfect! Just upload your custom
                                invitation in seconds. If you don’t have one, it’s ok!
                            </p>
                        </Card>
                        <Card title="2. Share Your Invitation">
                            <p className="text-secondary-text">
                                Once your invite is uploaded, we’ll create a unique link that
                                you can easily share with friends, family, or colleagues. Send
                                it directly yourself, or choose our optional delivery service,
                                and we’ll handle the emailing or texting to each guest on your
                                behalf.
                            </p>
                        </Card>
                        <Card title="3. Track and Manage Responses">
                            <p className="text-secondary-text">
                                Easily see who’s viewed your invite and who’s responded. Stay
                                organized and keep track of your event all in one place.
                            </p>
                        </Card>
                    </div>
                </div>
...
export function Nav() {
    return (
        <nav className="flex justify-between border-b border-outline py-6" id="nav">
...
export function Footer() {
    return (
        <footer className="mb-9 space-y-9" id="footer">
                ...
                <div className="flex gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3 text-secondary-text hover:[&>*]:underline">
                            ...
                            <li>
                                <Link href={"/#request-features"}>Request features</Link>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className="flex justify-between border-t border-outline p-4 text-secondary-text">
