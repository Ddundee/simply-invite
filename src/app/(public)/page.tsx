...
export default function Page() {
    ...
    useEffect(() => {
        if (auth.isSignedIn) void router.prefetch("/dashboard");
                ...
                <div className="space-y-9" id="how-it-works">
                    ...
                    <div className="grid gap-6 lg:grid-cols-3">
                        <Card className="bg-secondary">
                            ...
                            <CardContent>
                                <p className="text-secondary-foreground/60">
                                    Already have a design? Perfect! Just upload
                                    your custom invitation in seconds. If you
                                    don’t have one, it’s ok!
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-secondary">
                            ...
                            <CardContent>
                                <p className="text-secondary-foreground/60">
                                    ...
                                    friends, family, or colleagues. Send it
                                    directly yourself, or choose our optional
                                    delivery service, and we’ll handle the
                                    emailing or texting to each guest on your
                                    behalf.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-secondary">
                            <CardHeader>
                                <CardTitle>
                                    3. Track and Manage Responses
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-secondary-foreground/60">
                                    Easily see who’s viewed your invite and
                                    who’s responded. Stay organized and keep
                                    track of your event all in one place.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
